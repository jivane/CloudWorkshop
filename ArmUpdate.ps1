...
Invoke-Command -ScriptBlock $sb -ComputerName $env:COMPUTERNAME | Out-Null
...
$chocoPackages.Split(",") | ForEach {
    ...
    Invoke-Command -ScriptBlock $sb -ArgumentList $chocoPackages -ComputerName $env:COMPUTERNAME | Out-Null
}
